...
API_KEY = "AIzaSyBRY-tiIC_PJzV1NuEPyWEKJyKNgDchPPs"
...
class WellnessLog(db.Model):
    ...
    def __init__(self, **kwargs):
        super(WellnessLog, self).__init__(**kwargs)
...
class DigitalDoulaLog(db.Model):
    ...
    def __init__(self, **kwargs):
        super(DigitalDoulaLog, self).__init__(**kwargs)
...
def create_initial_data():
    ...
    with app.app_context():
        # Drop all tables to ensure schema is up-to-date (for development)
